...
import 'package:hotel_booking/src/helper/extension/string_extension.dart';
...
class FormValidator{
  ...
  /// The error message for empty review input.
  static const _emptyReviewInputError = 'Please enter your review';
